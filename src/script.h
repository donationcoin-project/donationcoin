...
#ifndef H_DONATIONCOIN_SCRIPT
#define H_DONATIONCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CDonationcoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Donationcoin always counted CHECKMULTISIGs
