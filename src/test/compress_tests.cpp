...
// amounts 1 .. 10000
#define NUM_MULTIPLES_1DON 10000

// amounts 50 .. 21000000
#define NUM_MULTIPLES_50DON (90000000 / 50)
...
BOOST_AUTO_TEST_CASE(compress_amounts)
{
    ...
    BOOST_CHECK(TestPair(90000000*COIN, 0x1406f40));
    ...
    for (uint64 i = 1; i <= NUM_MULTIPLES_1DON; i++)
        BOOST_CHECK(TestEncode(i * COIN));

    for (uint64 i = 1; i <= NUM_MULTIPLES_50DON; i++)
