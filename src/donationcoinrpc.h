...
#ifndef _DONATIONCOINRPC_H_
#define _DONATIONCOINRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // Donationcoin is not connected
...
/**
 * Donationcoin RPC command dispatcher.
 */
class CRPCTable
{
private:
