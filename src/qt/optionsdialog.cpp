    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new DonationcoinUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->donationcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Donationcoin."), QMessageBox::Ok);
