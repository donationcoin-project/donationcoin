...
unlocked to sign the Donationcoin-Qt.app bundle.
...
allowing somebody to distribute a Donationcoin-Qt.app or donationcoin-qt-setup.exe with a valid
...
that the donationcoin-qt.exe file inside the installer had not been tampered with.
